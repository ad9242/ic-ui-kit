...
<Canvas>
  <Story name="With icon" parameters={{ loki: { skip: true } }}>
    {html`<div>
        ...
        >
          <ic-button variant="primary" theme="light">
            Button
            <svg
              slot="left-icon"
              xmlns="http://www.w3.org/2000/svg"
          ...
          <ic-button variant="secondary" theme="light">
            Button
            <svg
              slot="left-icon"
              xmlns="http://www.w3.org/2000/svg"
          ...
          <ic-button variant="tertiary" theme="light">
            Button
            <svg
              slot="left-icon"
              xmlns="http://www.w3.org/2000/svg"
