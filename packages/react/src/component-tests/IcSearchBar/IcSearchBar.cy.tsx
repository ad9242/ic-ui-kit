...
describe("IcSearchBar visual regression and a11y tests", () => {
  ...
  it("should render basic search bar", () => {
    mount(<Basic />);
  ...
  it("should render search bar within a form", () => {
    mount(<InAForm />);
  ...
  it("should render search bar with query search mode", () => {
...
describe("IcSearchBar visual regression tests in high contrast mode", () => {
  ...
  it("should render basic search bar in high contrast mode", () => {
    mount(<Basic />);
